...
def integrate_code_base():
	try:
		...
		fin = open('modules/authentication/common/authentication.py', 'r')
		authentication_common_authentication = fin.read()

		fin = open('modules/general/app_run.py', 'r')
		general_app_run = fin.read()

		# integrated all files variables data into the one variable
		combined_file = general_app_init + landing_web_landing + load_data_web_load_data + load_data_common_load_data + trade_data_common_trade_data + trade_data_web_trade_data + generation_data_common_generation_data + generation_data_web_generation_data + authentication_common_authentication + general_app_run
